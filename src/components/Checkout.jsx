...
const Checkout = () => {
  ...
  return (
    <main className='min-h-screen flex w-full  flex-col  mt-5   items-center'>
        <h1 className='text-[3rem] text-[#04364A] mb-8'>اكمال الطلب</h1>
        <div className='w-full h-full flex flex-row justify-center '>

        <div className='  h-full w-[40rem]  flex flex-col  justify-center items-center'>
        ...
        <div className=' h-full w-[40rem]  ml-12 flex flex-col justify-center items-center '>
            ...
            CartProducts?.map((product) => (
              <div className='w-full h-[10rem]   mb-4 flex flex-row justify-end p-2 border-[0.2rem] border-[#BACBD1] rounded-xl'>
                ...
                <div className='w-full h-full flex flex-col  items-end mr-6'>
                  <h1 className='text-[1.5rem] text-[#04364A] font-medium'>{product.title}</h1>
                  <h1 className='text-[1.4rem] mt-4'>{product.price}</h1>
                </div>
